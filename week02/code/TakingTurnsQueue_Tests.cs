...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Each new person is queued at the front of the que instead at the back.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The "GetNextPerson" function does not account for the 0 (aka infinite) turn persons and only ques them once.
    ...
    // Defect(s) Found: The "GetNextPerson" function does not account for the negative number (aka infinite) turn persons and only ques them once.
